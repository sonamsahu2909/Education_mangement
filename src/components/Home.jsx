    ...
    <>
      <div className="site-wrap">
                  ...
                  <div className="course-1-item">
                    ...
                    <div className="course-1-content pb-4">
                      ...
                      <p className="desc mb-4">
                        ...
                        elit. Similique accusantium ipsam.
                      </p>
                      <p>
                        <a
                          href="/course-single"
        ...
        <div
          ...
          style={{backgroundImage: "url('images/about_1.jpg')"}}
        >
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-8">
                <p className="lead">
                  ...
                  nesciunt quaerat ad reiciendis perferendis voluptate fugiat
                  sunt fuga error totam.
                </p>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  ...
                  necessitatibus rem debitis architecto dolore? Nam omnis
                  sapiente placeat blanditiis voluptas dignissimos, itaque fugit
                  a laudantium adipisci dolorem enim ipsum cum molestias? Quod
                  quae molestias modi fugiat quisquam. Eligendi recusandae
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="post-entry-big">
                      <a href="/news-single" className="img-link">
                        <img
                  ...
                  <div className="col-lg-6">
                    <div className="post-entry-big horizontal d-flex mb-4">
                      <a href="/news-single" className="img-link mr-4">
                        <img
